 ...
 */
class Customer extends \DataAccess\FFM\Entity\Customer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'DataAccess\\FFM\\Entity\\Customer' . "\0" . 'version', 'email', 'name', 'company', '_created', '_updated'];
        }
